...
public class QRscannerActivity extends AppCompatActivity {
    ...
    private Button cameraBtn, galleryBtn, scanBtn;
        ...
        scanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (imageUri == null){
                    ...
                    Toast.makeText(QRscannerActivity.this, "Pick image first...", Toast.LENGTH_SHORT).show();
                }
                else {
            ...
            Task<List<Barcode>> barcodeResult = barcodeScanner.process(inputImage)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(QRscannerActivity.this, "Failed scanning due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void extractBarcodeQRCodeInfo(List<Barcode> barcodes) {
        ...
        for (Barcode barcode : barcodes){
            ...
            int valueTypes = barcode.getValueType();
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Toast.makeText(QRscannerActivity.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
